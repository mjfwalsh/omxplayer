...
# packages
REQUIRED_OMX_PKGS="git sed gcc g++ pkg-config binutils libasound2-dev libpcre2-dev libboost-dev libfreetype6-dev libcairo2-dev libdvdread-dev libdbus-1-dev"
